...
function fillArrays() {
  var temp = "";
//   socket.on('id',function (data) { //Will be back soon ISA
//     if(data[1] == 1) {
...
// var player1="02c03";         //north        player1.card
// var player2="14d02";         //east         player2.card
// var player3="20d08";         //south        player3.card
// var player4="26d01";         //west         player4.card
  ...
  function writeLine(data){
    ...
    //  message.classList.add('message')
     socket.on('addtochat',function(data){
         console.log(data);
        messages.innerHTML += 'player says: ' + data  + "</br>";
